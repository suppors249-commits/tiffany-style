...
export function HeroSection() {
  ...
  >
    إكسسوارات ستانلس ستيل مطلية بالذهب
  </h2>
  ...
  >
    اكتشف مجموعة مميزة من الإكسسوارات العصرية المصممة بعناية  
    لتجمع بين الفخامة والبساطة.  
    قطع أنيقة مقاومة للصدأ تدوم طويلاً وتمنحك إطلالة مميزة في كل وقت.
  </p>
